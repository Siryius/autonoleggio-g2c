...
import it.unisa.tsw2.services.PraticaService;
...
public class ServicePraticaAction extends BasePraticaAction 
{
	...
	public String insertPratica()throws Exception 
	{
		...
		try
		{
			System.out.println(tmp_pratica.getNome());
			tmp_service.persist(tmp_pratica,tmp_pratica.getNome());		
		}
		catch(Exception e)
		{
	...
	public String deletePratica() throws Exception 
	{
		...
		try
		{
			tmp_service.deletePratica(tmp_pratica,tmp_pratica.getNome());
	...
	public String searchPraticaByNome_pratica() throws Exception 
	{
		...
		try
		{
			tmp_pratica=tmp_service.findByNome_pratica(tmp_pratica.getNome());
