...
public class ServiceCategoriaAction extends BaseCategoriaAction 
{
	public String insertCategoria()throws Exception 
	{
		...
		try
		{
			System.out.println(tmp_categoria.getNome()+" "+tmp_categoria.getDescrizione()+" "+tmp_categoria.getTariffa());
			tmp_service.persist(tmp_categoria,tmp_categoria.getNome());		
		}
		catch(Exception e)
		{
	...
	public String deleteCategoria() throws Exception 
	{
		...
		try
		{
			tmp_service.deleteCategoria(tmp_categoria,tmp_categoria.getNome());
	...
	public String searchCategoriaByNome_categoria() throws Exception 
	{
		...
		try
		{
			tmp_categoria=tmp_service.findByNome_categoria(tmp_categoria.getNome());
