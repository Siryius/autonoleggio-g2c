...
public class ServiceSedeAction extends BaseSedeAction 
{
	...
	public String insertSede()throws Exception 
	{
		...
		try
		{
			System.out.println(tmp_sede.getNome());
			tmp_service.persist(tmp_sede,tmp_sede.getNome());		
		}
		catch(Exception e)
		{
	...
	public String deleteSede() throws Exception 
	{
		...
		try
		{
			tmp_service.deleteSede(tmp_sede,tmp_sede.getNome());
	...
	public String searchSedeByNome_sede() throws Exception 
	{
		...
		try
		{
			tmp_sede=tmp_service.findByNome_sede(tmp_sede.getNome());
