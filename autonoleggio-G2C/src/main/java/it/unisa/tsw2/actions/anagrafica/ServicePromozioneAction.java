...
public class ServicePromozioneAction extends BasePromozioneAction 
{
	...
	public String insertPromozione()throws Exception 
	{
		...
		try
		{
			System.out.println(tmp_promozione.getNome());
			tmp_service.persist(tmp_promozione,tmp_promozione.getNome());		
		}
		catch(Exception e)
		{
	...
	public String deletePromozione() throws Exception 
	{
		...
		try
		{
			tmp_service.deletePromozione(tmp_promozione,tmp_promozione.getNome());
	...
	public String searchPromozioneByNome_promozione() throws Exception 
	{
		...
		try
		{
			tmp_promozione=tmp_service.findByNome_promozione(tmp_promozione.getNome());
