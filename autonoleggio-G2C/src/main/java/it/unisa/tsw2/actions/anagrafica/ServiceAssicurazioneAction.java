...
public class ServiceAssicurazioneAction extends BaseAssicurazioneAction 
{
	...
	public String insertOptional()throws Exception 
	{
		...
		try
		{
			System.out.println(tmp_assicurazione.getNome());
			tmp_service.persist(tmp_assicurazione,tmp_assicurazione.getNome());		
		}
		catch(Exception e)
		{
	...
	public String deleteAssicurazione() throws Exception 
	{
		...
		try
		{
			tmp_service.deleteAssicurazione(tmp_ass,tmp_ass.getNome());
	...
	public String searchAssicurazioneByNome_optional() throws Exception 
	{
		...
		try
		{
			tmp_ass=tmp_service.findByNome_assicurazione(tmp_ass.getNome());
